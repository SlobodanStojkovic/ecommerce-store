...
export function* fetchCategoriesAsync() {
  try {
    const categoriesArray = yield call(getCategoriesAndDocuments, "categories"); //when we want to turn function into an effect we use call method, and pass to it method and parameters
